...
private ImageView write;
    public PublishDailog(Context context) {
        this(context, R.style.main_publishdialog_style);
    }

    private PublishDailog(Context context, int theme) {
        super(context, theme);
    ...
    public PublishDailog setArticleBtnClickListener(android.view.View.OnClickListener clickListener) {
        llBtnArticle.setOnClickListener(clickListener);
        return this;
    }

    public PublishDailog setMiniBlogBtnClickListener(android.view.View.OnClickListener clickListener) {
        llBtnMiniBlog.setOnClickListener(clickListener);
        return this;
    }

    public PublishDailog setLetterBtnClickListener(android.view.View.OnClickListener clickListener) {
        llBtnLetter.setOnClickListener(clickListener);
        return this;
    }

    public PublishDailog setPhotoBtnClickListener(android.view.View.OnClickListener clickListener) {
