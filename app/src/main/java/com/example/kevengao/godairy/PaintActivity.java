...
import com.example.kevengao.godairy.view.PaintView;
...
public class PaintActivity extends Activity {
	...
	//底部的那几个按钮控制
	private int[]  paintItems = {R.drawable.paint_more, R.drawable.paint_pencil,
	...
	public void showPaintColorDialog(View parent){
		...
		alertDialogBuilder.setTitle("画笔颜色：");
	...
	public void showPaintSizeDialog(View parent){
		AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(this,R.style.custom_dialog);
		alertDialogBuilder.setTitle("画笔大小：");
	...
	public void showMoreDialog(View parent){
		AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(this,R.style.custom_dialog);
		alertDialogBuilder.setTitle("画笔和橡皮擦：");
