package com.example.kevengao.godairy.view;
...
public class TouchView extends View {
	...
	//画笔颜色
	private int[] paintColor = {Color.RED, Color.BLUE, Color.BLACK, Color.GREEN, Color.YELLOW, Color.CYAN, Color.LTGRAY
	};
	...
	public void setPaintStyle(){
		...
		mPaint.setAntiAlias(true);// 创建线条画笔
		mPaint.setDither(true);//防止画图边缘锯齿
		...
		mPaint.setStrokeWidth(currentSize);//设置画笔宽
